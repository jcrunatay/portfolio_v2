    ...
    return (
        <section id="experience" className="dark-section">
            ...
            <SectionAnimation 
                ...
                threshold={0.8}
            />
            <h2 ref={headingRef} className={`title section-title ${isTitleVisible ? "section-title-animate" : ""}`} ><span className="dark-title-line title-line"></span>Experience<span className="dark-title-line title-line"></span></h2>
            <div className={`div div1 ${isVisible ? "animate1" : ""}`} ref={divRef}>
                <div className="skills-work-main-container">
                    ...
                    <div className="work-description-container">
                        <p className="responsibilities-text"><strong>Creating Web Pages:</strong>I wrote code using languages like HTML, CSS, and JavaScript and also Bootstrap framework to bring designs to life. This involves building the layout, styling elements, and making things interactive.</p>
                        <p className="responsibilities-text"><strong>Working on Designs:</strong>I collaborated closely with the designer to turn their visual concepts into functional and appealing web pages. It was exciting to see designs come to life on the screen!</p>
                        <p className="responsibilities-text"><strong>Testing and Fixing Issues:</strong> I help test websites on different browsers and devices to ensure everything looks and works well. When I find bugs or glitches, I dove into troubleshooting and fixing them to make sure users have a smooth experience.</p>
                    </div>
