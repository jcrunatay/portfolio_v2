...
export default function Contact() {
    ...
    return (
        <section id="contact" className="light-section">
            ...
            >
                <span className="light-title-line title-line"></span>Get In Touch
                <span className="light-title-line title-line"></span>
            </h2>
            <div
                ref={divRef}
                className={`contact-content-wrapper div div1 ${isVisible ? "animate1" : ""}`}
            >
                <p className="contact-text">
                    Thank you for visiting my portfolio! If you have any inquiries, opportunities,
                    or just want to say hello, feel free to reach me.
                </p>
                <p className="contact-text">
                    I'm always open to connecting and discussing potential collaborations, projects,
                    or any questions you might have. Looking forward to hearing from you!
                </p>
                <div id="send-email-container">
                    <a id="email-btn" href="mailto:juyanrunatay@gmail.com">
                        {" "}
                        Say Hello{" "}
                    </a>
                    <br />
